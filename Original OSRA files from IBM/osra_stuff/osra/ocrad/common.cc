...
void Ocrad::internal_error( const char * const msg ) throw()
  {
...
bool Ocrad::similar( const int a, const int b,
                     const int percent_dif, const int abs_dif ) throw()
  {
...
bool Charset::enable( const char * const name ) throw()
  {
...
bool Charset::enabled( const Value cset ) const throw()
  {
...
bool Charset::only( const Value cset ) const throw()
  {
  if( !charset_ ) return cset == iso_8859_15;		// default charset
  return charset_ == cset;
  }
...
bool Filter::set( const char * const name ) throw()
  {
...
bool Transformation::set( const char * const name ) throw()
  {
...
bool Control::set_format( const char * const name ) throw()
  {
